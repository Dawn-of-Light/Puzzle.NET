...
Imports MatsSoft.ObjectMapper.Tools
Imports MatsSoft.ObjectMapper.GUI.ProjectModel
Imports System.IO
...
Public Class WrapDbWizardService
    ...
    Public Function ExecuteWizard( _
        ...
        Dim sourceType As SourceTypeEnum
        ...
        Select Case sourceTypeName
            ...
            Case "Microsoft SQL Server/MSDE"
                ...
                sourceType = SourceTypeEnum.MSSqlServer

            Case "Microsoft Access 4.0"

                sourceType = SourceTypeEnum.MSAccess

            Case "Borland InterBase"

                sourceType = SourceTypeEnum.Interbase
    ...
    Private Function DoExecuteWizard( _
        ...
        ByVal sourceType As SourceTypeEnum, _
        ByVal providerType As ProviderTypeEnum, _
        ByVal connectionString As String, _
        ByVal targetLanguage As String, _
        ByVal targetDirectory As String, _
        ByVal copyOriginal As Boolean, _
        ...
        Select Case sourceType
            ...
            Case SourceTypeEnum.MSSqlServer
                ...
                Select Case providerType
                    ...
                    Case ProviderTypeEnum.SqlClient

                        tool = New SourceToTablesMSSqlServer

                    Case ProviderTypeEnum.Bdp
    ...
    Private Sub DoClassesToCode( _
        ...
        code = classesToCode.DomainToProject(domainMap, targetDirectory, classMapsAndFiles)
        ...
        fileName = targetDirectory & "\bin\MatsSoft.NPersist.framework.dll"

        src = useCfg.GetSourceCodeFile("MatsSoft.NPersist.Framework.dll")

        If File.Exists(Application.StartupPath & "\MatsSoft.NPersist.framework.dll") Then

            Try

                File.Copy(Application.StartupPath & "\MatsSoft.NPersist.framework.dll", fileName, True)
        ...
        If src Is Nothing Then
            ...
            src = useCfg.SetSourceCodeFile("MatsSoft.NPersist.Framework.dll", fileName)
