    ...
    Public Overloads Overrides Function GetStandardValues(ByVal context As System.ComponentModel.ITypeDescriptorContext) As System.ComponentModel.TypeConverter.StandardValuesCollection
        ...
        If Not propertyMap Is Nothing Then
            ...
            If propertyMap.IsCollection Then
                ...
                listDataTypes.Add("System.Collections.IList")
                'listDataTypes.Add("System.Array")
                listDataTypes.Add("System.Collections.ArrayList")

                Select Case LCase(propertyMap.ItemType)

                    Case "string", "system.string"
                        listDataTypes.Add("System.Collections.Specialized.StringCollection")
